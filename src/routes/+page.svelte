<div class="flex h-px grow flex-col overflow-y-auto">
	...
	<div class="card card-compact mx-auto w-96 bg-primary text-black">
		...
		<div class="card-body">
			...
			<p>
				Students location are not tracked in real time to make sure that they stay in the vicinity
				of the class. Therefore privacy of the student is not tampered with.
			</p>
		</div>
	</div>
	<br /><br />
